// Code generated by "enumer -type=LogLevel -text -json -trimprefix LogLevel -transform=snake -output log_level_enumer.go -comment log level"; DO NOT EDIT.
...
func (i LogLevel) String() string {
	if i >= LogLevel(len(_LogLevelIndex)-1) {
