...
func easyjsonD2b7633eDecodeGithubComRasikrrCoreApi(in *jlexer.Lexer, out *EmptySuccessResponse) {
...
func easyjsonD2b7633eEncodeGithubComRasikrrCoreApi(out *jwriter.Writer, in EmptySuccessResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
